...
| **O4** | **Do correction notices belong in the corpus?** An erratum that fixes a sample size or a p-value makes the *uncorrected* paper wrong on exactly what this study scores. 3 parents affected. Answering this also resolves the Patterson `2022a`/`2022b` ambiguity. | Corpus definition |
